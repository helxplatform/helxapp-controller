...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=helxapp-manager-role crd webhook paths="./..." output:crd:artifacts:config=config/crd/bases
...
## Location to install build-tool dependencies (platform-specific, not checked in)
LOCALBIN ?= /tmp/helxapp-controller/bin
$(LOCALBIN):
	mkdir -p $(LOCALBIN)
